...
public final class MActionNameTest
{
  ...
  public Stream<DynamicTest> testInvalids()
  {
    return Stream.of("", "A", String.format("%0257x", Integer.valueOf(123)))
      .map(MActionNameTest::invalidTestOf);
  }
  ...
  public Stream<DynamicTest> testValids()
  {
    return Stream.of(
      ...
      .map(MActionNameTest::validTestOf);
  }

  @Property
  public void testValid(
    @ForAll final MActionName name0,
    @ForAll final MActionName name1)
  {
    Assertions.assertEquals(
      name0.compareTo(name1),
      name0.value().compareTo(name1.value())
    );
  }
    ...
    @StringLength(min = 1, max = 16) final String textB)
  {
    Assertions.assertEquals(
      ...
      new MActionName(textA).compareTo(new MActionName(textB))
    );
  }
}
