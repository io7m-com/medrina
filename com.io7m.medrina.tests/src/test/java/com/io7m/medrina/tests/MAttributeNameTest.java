...
public final class MAttributeNameTest
{
  ...
  {
    EqualsVerifier.forClass(MAttributeName.class)
  ...
  public Stream<DynamicTest> testInvalids()
  {
    return Stream.of("", "A", String.format("%0257x", Integer.valueOf(123)))
      .map(MAttributeNameTest::invalidTestOf);
  }
  ...
  public Stream<DynamicTest> testValids()
  {
    return Stream.of(
      ...
      .map(MAttributeNameTest::validTestOf);
  }
    ...
    @StringLength(min = 1, max = 16) final String textB)
  {
    Assertions.assertEquals(
      ...
      new MAttributeName(textA).compareTo(new MAttributeName(textB))
    );
  }
}
