...
public final class MAttributeValueTest
{
  ...
  {
    EqualsVerifier.forClass(MAttributeValue.class)
  ...
  public Stream<DynamicTest> testInvalids()
  {
    return Stream.of("", "A", String.format("%0257x", Integer.valueOf(123)))
      .map(MAttributeValueTest::invalidTestOf);
  }
  ...
  public Stream<DynamicTest> testValids()
  {
    return Stream.of(
      ...
      .map(MAttributeValueTest::validTestOf);
  }
    ...
    @StringLength(min = 1, max = 16) final String textB)
  {
    Assertions.assertEquals(
      ...
      new MAttributeValue(textA).compareTo(new MAttributeValue(textB))
    );
  }
}
