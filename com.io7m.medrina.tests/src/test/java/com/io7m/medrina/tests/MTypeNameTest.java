...
public final class MTypeNameTest
{
  ...
  {
    EqualsVerifier.forClass(MTypeName.class)
  ...
  public Stream<DynamicTest> testInvalids()
  {
    return Stream.of("", "A", String.format("%0257x", Integer.valueOf(123)))
      .map(MTypeNameTest::invalidTestOf);
  }
    ...
    @StringLength(min = 1, max = 16) final String textB)
  {
    Assertions.assertEquals(
      ...
      new MTypeName(textA).compareTo(new MTypeName(textB))
    );
  }
}
