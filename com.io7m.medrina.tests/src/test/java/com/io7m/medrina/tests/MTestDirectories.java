...
public final class MTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(MTestDirectories.class);

  private MTestDirectories()
  {
    ...
    throws IOException
  {
    ...
    final var path = Path.of(property).resolve("medrina");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/medrina/tests/%s", name);
